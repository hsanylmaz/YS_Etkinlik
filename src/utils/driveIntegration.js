...
export async function uploadToGoogleDrive(base64Docx, filename) {
    ...
    try {
        ...
        if (error.message === "Failed to fetch") {
            throw new Error("Bağlantı kurulamadı (Failed to fetch). Bu durum genellikle Google Apps Script Web Uygulamanızın izin ayarlarından veya tarayıcınızdaki reklam engelleyicilerden (AdBlock vb.) kaynaklanır. Lütfen reklam engelleyicinizi kapatıp veya Gizli Sekmede yeniden deneyin.");
        }
        throw error;
    }
}
