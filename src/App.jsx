...
`;
      ...
      const standardEtkinlikId = `${yearSuffix}-${baseCode}${techSuffix}-${uniqueSuffix}`;
...
5. ETKİNLİK ID KURALI:
   - 'Etkinlik ID' hücresine KESİNLİKLE tam olarak '${standardEtkinlikId}' değerini yazınız. Format: [YIL]-[KAZANIM_KODU][TEKNOLOJİ_ROZETİ]-[BENZERSİZ_KOD] (Örn: '26-İTA.8.2.1-A7K', '26-MAT.5.1.2-KIT-3X8', '26-FEN.6.3.1-3B-9M2', '26-BİL.5.2.1-KIT-3B-4R1').
`;
...
| **Örnek Tasarımın Düzenlenebilir Dosya Linki (.STL)** | • [🔍 Thingiverse'de Ara](https://www.thingiverse.com/search?q=INGILIZCE_KONU_TERIMLERI) <br> • [🔍 Printables'da Ara](https://www.printables.com/search/models?q=INGILIZCE_KONU_TERIMLERI) <br> • [🔍 Tinkercad'de Ara](https://www.tinkercad.com/search?q=INGILIZCE_KONU_TERIMLERI) <br> • [🔍 Creality Cloud'da Ara](https://www.crealitycloud.com/search/model?q=INGILIZCE_KONU_TERIMLERI) |
