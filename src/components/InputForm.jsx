...
export default function InputForm({
  ...
  return (
    <div className="glass-panel rounded-3xl p-6 md:p-8 mb-8 bg-white shadow-xl border border-slate-100">
      {/* 1. Bölüm: Belge Türü */}
      <div className="mb-8 bg-slate-50 p-5 rounded-2xl border border-slate-100 flex items-center justify-between">
        <div>
          <span className="text-xs font-extrabold text-blue-600 uppercase tracking-wider block mb-1">📄 Belge Formatı</span>
          <h2 className="text-base font-bold text-slate-800">Teknoloji Destekli Aktif Öğrenme Etkinlik Planı</h2>
          <p className="text-xs text-slate-500 mt-0.5">Özel 'Etkinlik Planı Şablonuna' göre birebir doldurulan resmî plan.</p>
        </div>
